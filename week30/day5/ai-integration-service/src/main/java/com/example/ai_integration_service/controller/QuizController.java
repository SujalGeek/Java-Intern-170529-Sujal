...
//    }
    ...
    @GetMapping("/midterm-paper/{courseId}")
    public ResponseEntity<?> getMidtermByCourse(@PathVariable Long courseId) {
        // Logic to fetch from midterm_exam table where course_id = 8
