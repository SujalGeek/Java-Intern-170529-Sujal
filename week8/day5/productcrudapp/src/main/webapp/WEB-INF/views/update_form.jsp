            ...
            <div class="col-md-8 offset-md-2">
                <div class="card shadow">
                    <div class="card-header bg-secondary text-dark text-center">
                        <h4 class="mb-0">Update Product (ID: ${product.id})</h4>
                    </div>
                    <div class="card-body">
                        
                        <!-- 
                            Action points to the update handler.
                            modelAttribute="product" binds existing data.
                        -->
                        <form:form action="../handle-update" method="post" modelAttribute="product">

                            <!-- HIDDEN ID FIELD: MUST be included to identify which product to update -->
                            <form:hidden path="id" />
                            ...
                            <div class="container text-center mt-4">
                                ...
                                <!-- Back Button: Goes back to the index page (/) -->
