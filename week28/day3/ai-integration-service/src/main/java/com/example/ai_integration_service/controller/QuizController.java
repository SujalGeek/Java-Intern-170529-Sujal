...
public class QuizController {
	...
	@GetMapping("/midterm/pdf/{midtermId}")
	public ResponseEntity<byte[]> exportPdf(@PathVariable Long midtermId) throws Exception {

	    byte[] pdf = aiIntegrationService.exportMidtermPdf(midtermId);

	    return ResponseEntity.ok()
	            .header("Content-Disposition", "attachment; filename=midterm.pdf")
