...
//	    saveDynamicSection(exam.getMidtermId(), sections.get("Section C - Long"), 10, courseId);
	    ...
	    saveDynamicSection(exam.getMidtermId(), sectionA, 2, courseId,"UNDERSTAND");
	    saveDynamicSection(exam.getMidtermId(), sectionB, 5, courseId,"APPLY");
	    saveDynamicSection(exam.getMidtermId(), sectionC, 10, courseId,"ANALYSE");
