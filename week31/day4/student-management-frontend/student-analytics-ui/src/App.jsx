...
import StudentPortal from './pages/StudentPortal'; // 🔥 NEW: Import the Student Portal
...
const RoleRoute = ({ children, allowedRoles }) => {
  ...
  if (allowedRoles && !allowedRoles.includes(userRole)) {
    ...
    if (userRole === 1) return <Navigate to="/admin-portal" />; // 🔥 Updated to default to the new Admin Command Center
