...
// concrete subject : a Youtube channel that obsevers can subscribe to
class Channel implements IChannel{
    ...
    public void notifySubscribers() {
        for(ISubscriber isx: subscribers)
        {
            isx.update();
        }
        // throw new UnsupportedOperationException("Not supported yet.");
...
/*
observer pattern defines a one-to-many dependency where when one object changes state,
