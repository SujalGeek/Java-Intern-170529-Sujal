...
public class PaymentsCommandsHandler {
    ...
    public void handleCommand(@Payload ProcessPaymentCommand command)
    {
        ...
        try {
            ...
            Payment processEvent = paymentService.process(payment);
            ...
            System.out.println("Payment is not processing after sending the kafka template");
        }
        catch (CreditCardProcessorUnavailableException ex)
        {
            ...
            System.out.println("Payment failed is processing");
