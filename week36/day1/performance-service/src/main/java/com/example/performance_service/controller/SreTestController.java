...
public class SreTestController {
    ...
    public SreTestController() {
        ...
        this.errorCounter = Counter.builder("core_errors")
                .description("Total number of java errors for SRE test in Peformance Service")
                .tag("service", "performance-service") // Tag zaroori hai taaki Prometheus ko pata chale ye Performance ka hai
