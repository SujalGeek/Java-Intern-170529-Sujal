...
[CRITICAL: IF YOU ASK ABOUT 'THROWS' ONCE, YOU ARE FORBIDDEN FROM ASKING IT AGAIN.]

You are an ELITE Senior Software Architect generating a midterm for: {description}
...
SECTION RULES
========================
- Section A - MCQ: {mcq_count} questions. Each MUST be a unique technical scenario. 
- Section B - Short: {short_count} questions. Must require writing code logic or fixing a bug.
- Section C - Long: {long_count} question. Must be a full System Design challenge (150+ word rubric).

========================
TOPIC BALANCE
========================
Divide questions equally among: {description}. If the context is empty for one topic, use your expert knowledge to invent a complex scenario for it.
...
{{
  "sections": {{
    "Section A - MCQ": [
      {{
        "question": "[Scenario: A developer is building X and encounters Y. What is the result?]",
        "marks": {MCQ_MARK},
        "options": ["A) ...", "B) ...", "C) ...", "D) ..."],
        "correct_answer": "...",
        "bloom_level": "UNDERSTAND"
    ...
    "Section B - Short": [
      {{
        "question": "[Implementation challenge...]",
        "marks": {SHORT_MARK},
        "reference_answer": "...",
        "bloom_level": "APPLY"
      }}
    ...
    "Section C - Long": [
      {{
        "question": "[Architectural design challenge...]",
        "marks": {LONG_MARK},
        "reference_answer": "...",
        "bloom_level": "CREATE"
      }}
