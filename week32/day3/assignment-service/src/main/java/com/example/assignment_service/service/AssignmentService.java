...
//    }
    ...
    public Double getAverageForStudent(Long studentId, Long courseId) {
    	...
    	String sql = "SELECT AVG(at.total_score) FROM assignment_attempt at " +
                "JOIN assignment a ON at.assignment_id = a.assignment_id " +
                "WHERE at.student_id = ? AND a.course_id = ?";
