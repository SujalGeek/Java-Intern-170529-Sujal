...
//
//	    System.out.println("Calling NLP evaluate at: " + URL);
//	    
...
//
//	            if (qa.getStudentAnswer().equalsIgnoreCase(correctAnswer)) {
...
//	   }
	...
	public Map<String, Object> submitMidterm(MidtermSubmitRequest request) {
	    ...
	    String grade = calcuateGrade(percentage);
	    ...
	    restTemplate.postForEntity(
	        "http://localhost:8085/api/performance/upsert",
	        dto,
	        Object.class
	    );
...
//	}
	...
	private String calcuateGrade(BigDecimal percentage)
	{
...
//	    }
	private void saveDynamicSection(
	    ...
	    for (Map<String, Object> questionMap : sectionData) {
	        ...
	        String dynamicBloom = questionMap.get("bloom_level") != null
	                ? questionMap.get("bloom_level").toString().toUpperCase()
	                : "UNDERSTAND";
