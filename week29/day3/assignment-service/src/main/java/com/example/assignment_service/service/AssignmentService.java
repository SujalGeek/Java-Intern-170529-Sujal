...
public class AssignmentService {
	...
	public Assignment generateAssignment(Long courseId,String description)
	{
		Map<String, Object> request = new HashMap<>();
		request.put("description", description);
		request.put("total_marks", 20);
		request.put("difficulty", "medium");
		
		ResponseEntity<Map> response = 
				restTemplate.postForEntity(NLP_URL, request, Map.class);
...
//	}
	...
	public AssignmentAttempt submitAssignment(SubmitAssignmentRequest request) {
	    ...
	    ResponseEntity<Map> response =
	            restTemplate.postForEntity(EVAL_URL, flaskRequest, Map.class);
