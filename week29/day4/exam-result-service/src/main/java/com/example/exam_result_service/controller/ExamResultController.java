...
//		return ResponseEntity.ok(examResultService.saveResult(dto));
	...
	public ResponseEntity<List<ExamResultSimpleDTO>> getByStudent(@PathVariable Long studentId)
	{
		List<ExamResultSimpleDTO> results =
	...
	public ResponseEntity<List<ExamResultSimpleDTO>> getByCourse(@PathVariable Long courseId)
	{
		List<ExamResultSimpleDTO> results =
	...
	public ResponseEntity<List<ExamResultSimpleDTO>> getByStudentAndCourse(@PathVariable Long studentId,@PathVariable Long courseId)
	{
		List<ExamResultSimpleDTO> results =
